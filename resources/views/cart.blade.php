...
@section('title', 'Kerangjang Belanja Anda')

@section('content')
<div class="container mx-auto p-6">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-6">Keranjang Belanja Anda</h2>
        <a href="{{ route('products.index') }}" class="mt-0 mb-3 inline-block text-cream underline hover:text-light-brown">
            <- Back to Menu
        </a>
        ...
        @else
                ...
                <table class="min-w-full bg-white border border-gray-200">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Produk</th>
                            <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Harga</th>
                            <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Jumlah</th>
                            <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Subtotal</th>
                            <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-3 px-4 text-gray-800">
                                    <form action="{{ route('cart.update', $item->id) }}" method="POST" class="flex items-center space-x-2">
                                        ...
                                        <button type="submit"
                                            class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-3 rounded text-sm">
                                            Update
                                        </button>
                                    </form>
                                </td>
                    ...
                    <tfoot>
                        <tr class="bg-gray-50">
                            <td colspan="3" class="py-3 px-4 text-right text-base font-bold text-gray-900">
                                Total Belanja:
                            </td>
            ...
            <div class="flex justify-end mt-6">
                <a href="{{ route('checkout.index') }}"
                    class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-md shadow-lg">
