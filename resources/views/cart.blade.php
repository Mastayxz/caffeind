...
@section('content')
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <a href="{{ route('products.index') }}" class="mt-0 mb-3 inline-block text-cream underline hover:text-light-brown"><- Back to Menu</a>

        @if ($cartItems->isEmpty())
            <p class="text-center text-gray-600">Keranjang belanja Anda kosong. Yuk, <a href="{{ url('/products') }}"
                    class="text-blue-600 hover:underline">mulai belanja</a>!</p>
        @else
