<div :class="open ? 'w-64 transition-all duration-300' : 'w-16 transition-all duration-300'"
    ...
    <nav class="flex-1">
        <ul class="space-y-2 px-2 text-white ">
            <li>
                <a href="{{ route('admin.dashboard') }}" class="{{ request()->routeIs('admin.dashboard') ? 'bg-[#A08963]' : 'bg-[#706D54]' }} flex items-center p-2 rounded  hover:bg-[#4B352A] ms-2">
            ...
            <li>
                <a href="{{ route('admin.users') }}" class="{{ request()->routeIs('admin.users') ? 'bg-[#A08963]' : 'bg-[#706D54]' }} flex items-center p-2 rounded  hover:bg-[#4B352A] ms-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
